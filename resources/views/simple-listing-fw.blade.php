          ...
          <div class="col-md-12">
            <nav class="navigation">
              <ul class="sf-menu">
                ...
                <li><a href="login.html">Register as Agent</a></li>
                  ...
                  <div class="col-md-12">
                      <div class="block-heading">
                          ...
                          <div class="toggle-view pull-right">
                              <a href="grid-listing-fw.html"><i class="fa fa-th-large"></i></a>
                    ...
                    <div class="property-listing">
                        <ul>
                          <li class="type-rent col-md-12">
                              <div class="col-md-4">
                                      <a href="#" class="property-featured-image"> <img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt=""> <span class="images-count"><i class="fa fa-picture-o"></i> 2</span> <span class="badges">Rent</span> </a>
                              </div>
                              <div class="col-md-8">
                                      ...
                                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam euismod sollicitudin nunc, eget pretium massa. Ut sed adipiscing enim, pellentesque ultrices erat. Integer placerat felis neque, et semper augue ullamcorper in. Pellentesque iaculis leo iaculis aliquet ultrices. Pellentesque iaculis leo iaculis. Pellentesque iaculis leo iaculis aliquet ultrices. Pellentesque iaculis leo iaculis.</p>
                                  </div>
                          ...
                          <li class="type-rent col-md-12">
                              <div class="col-md-4">
                                      <a href="#" class="property-featured-image"> <img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt=""> <span class="images-count"><i class="fa fa-picture-o"></i> 2</span> <span class="badges">Buy</span> </a>
                              </div>
                              <div class="col-md-8">
                                      <div class="property-info">
                          ...
                          <li class="type-rent col-md-12">
                              ...
                              <div class="col-md-8">
                                      ...
                                      <h3><a href="#">459 West Broadway</a></h3>
                                      <span class="location">NYC</span>
                                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam euismod sollicitudin nunc, eget pretium massa. Ut sed adipiscing enim, pellentesque ultrices erat. Integer placerat felis neque, et semper augue ullamcorper in. Pellentesque iaculis leo iaculis aliquet ultrices. Pellentesque iaculis leo iaculis. Pellentesque iaculis leo iaculis aliquet ultrices. Pellentesque iaculis leo iaculis.</p>
                                  </div>
                                  <div class="property-amenities clearfix">
