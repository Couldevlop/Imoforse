                  ...
                  <div class="col-md-9">
                    ...
                    <div class="agents-listing">
                        <ul>
                          <li class="col-md-12">
                              <div class="col-md-4">
                                      <a href="{{ url('/agentDetail') }}" class="agent-featured-image"> <img src="{{ asset('/images/600x400.png') }}" alt=""></a>
                              </div>
                              <div class="col-md-8">
                                      <div class="agent-info">
                                      <div class="counts"><strong>18</strong><span>Properties</span></div>
                                      <h3><a href="{{ url('/agentDetail') }}">Brooklyn Coyle</a></h3>
                          ...
                          <li class="col-md-12">
                              ...
                              <div class="col-md-8">
                                      ...
                                      <h3><a href="{{ url('/agentDetail') }}">Ben Patel</a></h3>
                                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vehicula dapibus mauris, quis ullamcorper enim aliquet sed. Maecenas quis eget tellus dui. Vivamus condimentum egestas.</p>
                                  </div>
                                  <div class="agent-contacts clearfix">
                                          <ul>
                          ...
                          <li class="col-md-12">
                              ...
                              <div class="col-md-8">
                                      ...
                                      <h3><a href="{{ url('/agentDetail') }}">Emma Dumas</a></h3>
                                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vehicula dapibus mauris, quis ullamcorper enim aliquet sed. Maecenas quis eget tellus dui. Vivamus condimentum egestas.</p>
                                  </div>
                                  <div class="agent-contacts clearfix">
                                          <ul>
                          ...
                          <li class="col-md-12">
                              ...
                              <div class="col-md-8">
                                      ...
                                      <h3><a href="{{ url('/agentDetail') }}">Mia Kennedy</a></h3>
                                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vehicula dapibus mauris, quis ullamcorper enim aliquet sed. Maecenas quis eget tellus dui. Vivamus condimentum egestas.</p>
                                  </div>
                                  <div class="agent-contacts clearfix">
                                          <ul>
