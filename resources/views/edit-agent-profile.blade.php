      ...
      <div class="row">
        ...
        <div class="col-md-8 col-sm-4 col-xs-4">
          <div class="contact-info-blocks hidden-sm hidden-xs">
            <div> <i class="fa fa-phone"></i> Free Line For You <span>080 378678 90</span> </div>
            <div> <i class="fa fa-envelope"></i> Email Us <span>sales@realspaces.com</span> </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="single-agent">
              <div class="counts pull-right"> <strong>Member Since </strong> <span>Friday, Jun 20, 2014</span></div>
              <h2 class="page-title"> admin </h2>
            </div>
            <form name="profile" action="" method="post" id="agent-profile-form" enctype="multipart/form-data">
              <div class="block-heading" id="details">
                <h4><span class="heading-icon"><i class="fa fa-user"></i></span>Profile Details ( admin )</h4>
              </div>
              <div class="padding-as25 margin-30 lgray-bg">
                <div class="row">
                  <div class="col-md-4 col-sm-4">
                    <input type="text" name="first_name" id="first_name" value="" class="form-control first_name" placeholder="First Name">
                  </div>
                  <div class="col-md-4 col-sm-4">
                    <input type="text" name="last_name" id="last_name" value=""  class="form-control last_name" placeholder="Last Name">
                  </div>
                  <div class="col-md-4 col-sm-4">
                    <input type="email" id="email" value="yourmail@mail.com" name="email" class="form-control email1" placeholder="Email">
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-4 col-sm-4">
                  ...
                  <div class="col-md-4 col-sm-4">
                    <input type="password" value="" name="pass1" id="pass1" class="form-control pwd1" placeholder="New password">
                  </div>
                  <div class="col-md-4 col-sm-4">
                    <input type="password" value="" name="pass2" id="pass2" class="form-control pwd2" placeholder="Confirm password">
                  </div>
                </div>
              </div>
              <div class="block-heading" id="additionalinfo">
                <h4><span class="heading-icon"><i class="fa fa-plus"></i></span>Personal Info</h4>
              </div>
              <div class="padding-as25 margin-30 lgray-bg">
                <div class="row">
                  <div class="col-md-4 col-sm-4 ">
                  ...
                  <div class="col-md-8 col-sm-8 submit-description">
                    <textarea name="description" id="description" class="form-control margin-0" rows="5" cols="10" placeholder="Agent Description" ></textarea>
                  </div>
                </div>
                <hr>
                <div class="row">
                  ...
                  <div class="col-md-8 col-sm-8 submit-image">
                    <div class="image-placeholder"><img src="" class="image-placeholder" id="agent-image" alt="600x400 (JPG)"/></div>
                    <input type="file" name="agent-image" id="agent-image" onChange="readURL(this);">
                  </div>
                </div>
              </div>
              <div class="block-heading" id="amenities">
                <h4><span class="heading-icon"><i class="fa fa-phone"></i></span>Contact Details</h4>
              </div>
              <div class="padding-as25 margin-30 lgray-bg">
                <div class="row">
                  <div class="col-md-6 col-sm-6">
                    <input type="text" value="" name="mobile-phone"  id="mobile-phone" class="form-control" placeholder="Mobile Phone">
                  </div>
                  <div class="col-md-6 col-sm-6">
                    <input type="text" value="" name="work-phone" id="work-phone" class="form-control" placeholder="Work Phone">
                  </div>
                </div>
              </div>
              <div class="block-heading" id="amenities">
                <h4><span class="heading-icon"><i class="fa fa-group"></i></span>Social Links</h4>
              </div>
              <div class="padding-as25 margin-30 lgray-bg">
                <div class="row">
                  <div class="col-md-3 col-sm-3">
                    <input type="text" value="" name="fb-link" id="fb-link" class="form-control" placeholder="Facebook">
                  </div>
                  <div class="col-md-3 col-sm-3">
                    <input type="text" value="" name="twt-link" id="twt-link" class="form-control" placeholder="Twitter">
                  </div>
                  <div class="col-md-3 col-sm-3">
                    <input type="text" value="" name="gp-link" id="gp-link" class="form-control" placeholder="Google Plus">
                  </div>
                  <div class="col-md-3 col-sm-3">
                    <input type="text" value="" name="msg-link" id="msg-link" class="form-control" placeholder="Message">
                  </div>
                </div>
              </div>
              <div class="text-align-center" id="submit-property">
                <button type="submit" name="submit" class="btn btn-primary btn-lg cus_submit"><i class="fa fa-check"></i> Submit Now</button>
              </div>
            </form>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3 col-sm-6 footer-widget widget">
          ...
          <ul>
            <li> <a href="blog-post.php">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</a> <span class="meta-data">1 March, 2014</span> </li>
            <li> <a href="blog-post.php">Lorem ipsum dolor sit amet elit, consectetur adipiscing.</a> <span class="meta-data">28 February, 2014</span> </li>
            <li> <a href="blog-post.php">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</a> <span class="meta-data">26 February, 2014</span> </li>
          </ul>
        </div>
        <div class="col-md-3 col-sm-6 footer-widget widget">
