        ...
        <div class="row">
          <div class="col-md-9">
            <div class="block-heading">
                ...
                <a href="listing-map.php" class="btn btn-primary btn-sm pull-right">View more properties <i class="fa fa-long-arrow-right"></i></a>
            </div>
              	...
              	<ul>
                	<li class="type-rent col-md-12">
                  	...
                  	<div class="col-md-8">
                    		<div class="property-info">
                      		<div class="price"><strong>$</strong><span>2800 Monthly</span></div>
                      		<h3><a href="property-detail.php">116 Waverly Place</a></h3>
                	...
                	<li class="type-rent col-md-12">
                  	...
                  	<div class="col-md-8">
                    		<div class="property-info">
                      		<div class="price"><strong>$</strong><span>250000</span></div>
                      		<h3><a href="property-detail.php">232 East 63rd Street</a></h3>
                      		<span class="location">NYC</span>
                      		<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    		</div>
                    		<div class="property-amenities clearfix">
                	...
                	<li class="type-rent col-md-12">
                  	...
                  	<div class="col-md-8">
                    		<div class="property-info">
                      		<div class="price"><strong>$</strong><span>300000</span></div>
                      		<h3><a href="property-detail.php">55 Warren Street</a></h3>
                      		<span class="location">NYC</span>
                      		<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    		</div>
                    		<div class="property-amenities clearfix">
          ...
          <div class="sidebar right-sidebar col-md-3">
            <div class="widget sidebar-widget popular-agent">
                <h3 class="widgettitle">Popular Agent</h3>
              	  <a href="#"><img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt="" class="img-thumbnail"></a>
                <a href="#" class="btn btn-sm btn-primary pull-right">more details</a>
             	  <h4><a href="#">Brooklyn Coyle</a></h4>
            </div>
            <div class="widget sidebar-widget latest-testimonials">
              <h3 class="widgettitle">Customer's Testimonials</h3>
              <ul class="testimonials">
                <li>
                  ...
                  <img src="http://placehold.it/80x80&amp;text=IMAGE+PLACEHOLDER" alt="Happy Client" class="testimonial-sender"> <cite>Mellisa - <strong>My company</strong> <br>
                  <a href="#">www.companyurl.com</a> </cite> </li>
              </ul>
            </div>
          </div>
        </div>
