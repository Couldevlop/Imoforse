          ...
          <div class="container">
              <div class="row">
                      ...
                      <div class="single-agent">
                          ...
                          <div class="row">
                              <div class="col-md-6 col-sm-6">
                                      <img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt="Mia Kennedy" class="img-thumbnail">
                              </div>
                              <div class="col-md-6 col-sm-6">
                  ...
                  <div class="sidebar right-sidebar col-md-3">
                      ...
                      <h3 class="widgettitle">More Agents</h3>
                          <ul>
                              <li>
                                  <div class="row">
                                      <div class="col-md-5 col-sm-5 col-xs-5">
                                          <a href="agent-detail.php"><img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt="Brooklyn Coyle" class="img-thumbnail"></a>
                                  </div>
                                  <div class="col-md-7 col-sm-7 col-xs-7">
                                      <strong><a href="agent-detail.php">Brooklyn Coyle</a></strong>
                              ...
                              <li>
                                  <div class="row">
                                      <div class="col-md-5 col-sm-5 col-xs-5">
                                          <a href="agent-detail.php"><img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt="Ben Patel" class="img-thumbnail"></a>
                                  </div>
                                  <div class="col-md-7 col-sm-7 col-xs-7">
                                      <strong><a href="agent-detail.php">Ben Patel</a></strong>
                                      <span class="badge"><i class="fa fa-phone"></i> 080 378678 90</span>
                                  </div>
                                  </div>
                              </li>
                              <li>
                                  <div class="row">
                                      <div class="col-md-5 col-sm-5 col-xs-5">
                                          <a href="agent-detail.php"><img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt="Emma Dumas" class="img-thumbnail"></a>
                                  </div>
                                  <div class="col-md-7 col-sm-7 col-xs-7">
                                      <strong><a href="agent-detail.php">Emma Dumas</a></strong>
                                      <span class="badge"><i class="fa fa-phone"></i> 080 378678 90</span>
                                  </div>
                                  </div>
                              </li>
                    ...
                    <div class="widget sidebar-widget widget-properties">
                        ...
                        <ul>
                              <li>
                                  <div class="row">
                                      <div class="col-md-5 col-sm-5 col-xs-5">
                                      <a href="property-detail.php"><img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt="" class="img-thumbnail"></a>
                                  </div>
                                  <div class="col-md-7 col-sm-7 col-xs-7">
                                      <strong><a href="property-detail.php">116 Waverly Place</a></strong>
                                      <div class="price"><strong>$</strong><span>2800 Monthly</span></div>
                                  </div>
                                  </div>
                              </li>
                              <li>
                                  ...
                                  <div class="col-md-7 col-sm-7 col-xs-7">
                                      <strong><a href="property-detail.php">70 Greene Street</a></strong>
                              ...
                              <li>
                                  ...
                                  <div class="col-md-7 col-sm-7 col-xs-7">
                                      <strong><a href="property-detail.php">55 Warren Street</a></strong>
                                      <div class="price"><strong>$</strong><span>300000</span></div>
                                  </div>
                                  </div>
                              </li>
