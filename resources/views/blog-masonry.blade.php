            ...
            <ul class="grid-holder col-3">
              <li class="grid-item post format-image">
                <div class="grid-item-inner"> <a href="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" data-rel="prettyPhoto" class="media-box"> <img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt=""> </a>
                  <div class="grid-content">
                    <h4><a href="blog-post.php">Blog post with featured image</a></h4>
              ...
              <li class="grid-item post format-gallery">
                <div class="grid-item-inner">
                  ...
                  <div class="grid-content">
                    <h4><a href="blog-post.php">Gallery Format Blog Post</a></h4>
                    <span class="meta-data"><span><i class="fa fa-calendar"></i> 24th Nov, 2013</span><span><a href="#"><i class="fa fa-tag"></i>Uncategorized</a></span></span> </div>
                </div>
              </li>
              <li class="grid-item post format-image">
                <div class="grid-item-inner"> <a href="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" data-rel="prettyPhoto" class="media-box"> <img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt=""> </a>
              ...
              <li class="grid-item post format-quote">
                <div class="grid-item-inner">
                  <div class="grid-content">
              ...
              <li class="grid-item post format-link">
                <div class="grid-item-inner"> <a href="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" data-rel="prettyPhoto" class="media-box"> <img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt=""> </a>
                  <div class="grid-content">
                    <h4><a href="blog-post.php">www.alinkpost.com</a></h4>
                    <span class="meta-data"><span><i class="fa fa-calendar"></i> 24th Nov, 2013</span><span><a href="#"><i class="fa fa-tag"></i>Uncategorized</a></span></span>
                  </div>
                </div>
              </li>
              <li class="grid-item post format-gallery">
                <div class="grid-item-inner">
                  ...
                  <div class="grid-content">
                    <h4><a href="blog-post.php">Anotehr Gallery Post</a></h4>
                    <span class="meta-data"><span><i class="fa fa-calendar"></i> 24th Nov, 2013</span><span><a href="#"><i class="fa fa-tag"></i>Uncategorized</a></span></span>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel. Donec vel mauris quam.</p>
                  </div>
                </div>
