              ...
              <ol class="comments">
                <li>
                  <div class="post-comment-block">
                    <div class="img-thumbnail"> <img src="http://placehold.it/431x600&amp;text=IMAGE+PLACEHOLDER" alt="avatar"> </div>
          ...
          <div class="col-md-3 sidebar">
            ...
            <div class="widget sidebar-widget">
                <h3 class="widgettitle">Post Categories</h3>
                  <ul>
                      <li><a href="#">Property</a> (10)</li>
                      <li><a href="#">Sold</a> (12)</li>
                      <li><a href="#">Agents</a> (34)</li>
                      <li><a href="#">Loans</a> (14)</li>
                  </ul>
            </div>
            <div class="widget sidebar-widget">
